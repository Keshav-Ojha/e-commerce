...
VALUES
    (nextval('product_seq'), 'Smartphone with 128GB storage', 'Smartphone', 100, 699.99, 1),
    (nextval('product_seq'), 'Laptop with 16GB RAM', 'Laptop', 50, 999.99, 1),
    (nextval('product_seq'), 'Science fiction novel', 'Sci-fi Book', 200, 19.99, 2),
    (nextval('product_seq'), 'T-shirt with custom design', 'Custom T-shirt', 150, 14.99, 3),
    (nextval('product_seq'), 'Pack of organic vegetables', 'Organic Veggies', 300, 9.99, 4);
